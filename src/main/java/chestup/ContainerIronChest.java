            ...
            case WRIRON:
                ...
                for (int playerInvRow = 0; playerInvRow < 3; playerInvRow++)
                    for (int playerInvCol = 0; playerInvCol < 9; playerInvCol++)
                        addSlotToContainer(new Slot(playerInventory, playerInvCol + playerInvRow * 9 + 9, leftCol + playerInvCol * 18, ySize - (4 - playerInvRow) * 18 - 6));
                for (int hotbarSlot = 0; hotbarSlot < 9; hotbarSlot++)
                    addSlotToContainer(new Slot(playerInventory, hotbarSlot, leftCol + hotbarSlot * 18, ySize - 20));
                break;
            case STEEL:
                for (int chestRow = 0; chestRow < type.getRowCount(); chestRow++)
                    for (int chestCol = 0; chestCol < type.getRowLength(); chestCol++)
                ...
                for (int playerInvRow = 0; playerInvRow < 3; playerInvRow++)
                    for (int playerInvCol = 0; playerInvCol < 9; playerInvCol++)
                        addSlotToContainer(new Slot(playerInventory, playerInvCol + playerInvRow * 9 + 9, leftCol + playerInvCol * 18, ySize - (4 - playerInvRow) * 18 - 36));
                for (int hotbarSlot = 0; hotbarSlot < 9; hotbarSlot++)
                    addSlotToContainer(new Slot(playerInventory, hotbarSlot, leftCol + hotbarSlot * 18, ySize - 50));
                break;
            default:
                for (int chestRow = 0; chestRow < type.getRowCount(); chestRow++)
                    for (int chestCol = 0; chestCol < type.getRowLength(); chestCol++)
                ...
                for (int playerInvRow = 0; playerInvRow < 3; playerInvRow++)
                    for (int playerInvCol = 0; playerInvCol < 9; playerInvCol++)
                        addSlotToContainer(new Slot(playerInventory, playerInvCol + playerInvRow * 9 + 9, leftCol + playerInvCol * 18, ySize - (4 - playerInvRow) * 18 - 56));
                for (int hotbarSlot = 0; hotbarSlot < 9; hotbarSlot++)
                    addSlotToContainer(new Slot(playerInventory, hotbarSlot, leftCol + hotbarSlot * 18, ySize - 70));
